...
/*     @Test
    fun `itinerary has objects`() {
        ...
        val objects: Set<VisitObject> = itinerary.visitObjects
        
        // WHEN
        itinerary.addVisitObject(VisitObject())
        itinerary.addVisitObject(VisitObject())
...
*/
    @Test
    fun `2 itineraries are equal if they have the same visitObjects in the same order`() {
        // GIVEN
